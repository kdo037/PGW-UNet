...
def construct_singal_3D_full(invar, inmonth_raw, inmodel='none'):
    ...
    #     #print(model)
    #     infile = '/home/khanh/Documents/ssp585_pgw/CMIP6_delta/ens_mean/%s/CMIP6.ens_mean.diff.%s.%sgrid.nc' % (inmodel, invar, inmodel)
...
#     # TT, var132 = v
#     rootgroup.variables['v'][t,:,:,:] += PGWdata['va']

rootgroup.variables['var132'][:,:,:,:] += PGWdata['va']
