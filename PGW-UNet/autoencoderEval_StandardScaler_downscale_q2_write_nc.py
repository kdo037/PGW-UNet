...
feaDir = '/glade/campaign/univ/uncs0034/kdo/ML/downscale/features_ssp585_2036_2046/'
metBaseFolder = '/glade/campaign/univ/uncs0034/kdo/ML/downscale/shapefiles_plotformat/'
outFeatureName = 'featuresMetem_d03_'
startDate = datetime(2006,11,4,0,0,0)  # start date
...
while startDate <= endDate:
    ...
    if os.path.exists(inFile):
        ...
        trainLabel = trainLabels[:,:,:,idxLabel]
        ...
        model.load_weights(modDir + '/savedWeights/checkpoint_400epochs_Standardscaler_Q2.weights.h5')
        ...
        p = 'q2_ssp585_36_46_d03_' + str(startDate.year) + str(startDate.month).zfill(2) + str(startDate.day).zfill(2)
